...
etabs <- subset(esr,Type %in% c("Université", "Grand établissement"), UAI:url.legifrance) %>% unique %>% arrange(desc(Type),Académie) 

#etabs <-filter(etabs, UAI %in% c(uai.ehess, uai.dauphine))
