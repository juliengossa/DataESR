...
ggplot(ps2018.all, aes(x=Capacité.de.l.établissement.par.formation, fill=Filière.de.formation.très.agrégée)) +
  ...
  xlab("Filière") + ylab("Proportion des formations")  +
...
ggplot(ps2018, aes(x=Filière.de.formation.très.agrégée, y=Taux.de.tension, fill=Filière.de.formation.très.agrégée)) +
  geom_violin() +
  xlab("Filière") + ylab("Taux de tension") + scale_fill_discrete(name="Fillère") +
...
ggplot(ps2018, aes(x=Filière.de.formation.très.agrégée, y=Taux.de.remplissage,
                   fill=Filière.de.formation.très.agrégée)) +
  geom_boxplot() +
  ylab("Taux de remplissage") + xlab("Filière") +
...
ggplot(ps2018, aes(x=Filière.de.formation.très.agrégée, y=Taux.de.sélection,
                   fill=Filière.de.formation.très.agrégée)) +
  geom_boxplot() +
  ylab("Taux de sélection") + xlab("Filière") +
  scale_y_continuous(labels=scales::percent) +
  scale_fill_discrete(name="Fillère") +
...
ggplot(ps2018, aes(x=Filière.de.formation.très.agrégée, y=X..d.admis.néo.bacheliers.boursiers,
                   fill=Filière.de.formation.très.agrégée)) +
  geom_boxplot() +
  ylab("Taux de boursiers") + xlab("Filière") +
